          ...
          <div className="relative z-10 px-8 md:px-16 py-20 text-center">
            ...
            >
              <a
                ...
                className="px-8 py-3.5 rounded-full bg-[#0071e3] hover:bg-[#0077ed] text-white text-[15px] font-medium transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] inline-flex items-center gap-2"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
